            ...
            <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
                ...
                <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
                    ...
                    <div className="flex flex-col gap-12 justify-center">
                        {/* BIOGRAPHY IMAGE */}
                        {/* <Image src="https://images.pexels.com/photos/775358/pexels-photo-775358.jpeg?auto=compress&cs=tinysrgb&w=800" alt="" width={112} height={112} className="w-28 h-28 rounded-full object-cover" /> */}
                        {/* BIOGRAPHY TITLE */}
                        <h1 className="font-bold text-2xl">BIOGRAPHY</h1>
                        {/* BIOGRAPHY DESC */}
                        <p className="text-lg">A passionate software engineer with a Master’s degree in IT (Software Engineering) from UTS. With over Three years of experience in agile web development, I specialize in modern JavaScript frameworks, Next.js, React, and backend technologies. My expertise extends to full-stack development, and Machine Learning.</p>
                        {/* BIOGRAPHY QUOTE */}
                        <span className="italic">Innovating through technology, one solution at a time.</span>
                        {/* BIOGRAPHY SIGN SVG*/}
                    ...
                    <div className="flex flex-col gap-12 justify-center" ref={skillRef}>
                        ...
                        <motion.div initial={{ x: "-300px" }} animate={isSkillRefInView ? { x: 0 } : {}} className="flex gap-4 flex-wrap">
                            ...
                            <div className="rounded  p-2 text-sm cursor-pointer bg-black text-white hover:bg-white hover:text-black">Fast API</div>
                    ...
                    <div className="flex flex-col gap-12 justify-center pb-48" ref={experienceRef}>
                        ...
                        <motion.div initial={{ x: "-300px" }} animate={isExperienceRefInView ? { x: "0" } : {}} className="">
                            ...
                            <div className="flex justify-between h-48">
                                ...
                                <div className="w-1/3 ">
                                    {/* JOB TITLE */}
                                    <div className="bg-white p-3 font-semibold rounded-b-lg rounded-s-lg">Frontend Developer (Contract)</div>
                                    {/* JOB DESC */}
                                    <div className="p-3 text-sm italic">Frontend web development with React and Next.js, designing scalable UI components.</div>
                                    {/* JOB DATE */}
                                    <div className="p-3 text-red-400 text-sm font-semibold">November 2024 - Present</div>
                                    {/* JOB COMPANY */}
                                    <div className="px-3 text-red-400 text-sm font-semibold underline">Bloomeco, Australia</div>
                                </div>
                                {/* CENTER */}
                            ...
                            <div className="flex justify-between h-48">
                                ...
                                <div className="w-1/3 ">
                                    {/* JOB TITLE */}
                                    <div className="bg-white p-3 font-semibold rounded-b-lg rounded-s-lg">IT Engineer (Internship)</div>
                                    {/* JOB DESC */}
                                    <div className="p-3 text-sm italic">Technical support and web application development with React and Node.js.</div>
                                    {/* JOB DATE */}
                                    <div className="p-3 text-red-400 text-sm font-semibold">August 2024 - December 2024</div>
                                    {/* JOB COMPANY */}
                                    <div className="px-3 text-red-400 text-sm font-semibold underline">OmniSystems Network Solutions, Australia</div>
                                </div>
                            </div>
                            {/* EXPERIENCE LIST ITEM */}
                            <div className="flex justify-between h-48">
                                ...
                                <div className="w-1/3 ">
                                    ...
                                    {/* JOB DESC */}
                                    <div className="p-3 text-sm italic">Full-stack web development with React.js and Node.js, migrating legacy Vue code.</div>
                                    {/* JOB DATE */}
                                    <div className="p-3 text-red-400 text-sm font-semibold">January 2021 - January 2023</div>
                                    {/* JOB COMPANY */}
                                    <div className="px-3 text-red-400 text-sm font-semibold underline">TechTrioz Solutions, Bangladesh</div>
                                </div>
                                {/* CENTER */}
                                <div className="w-1/6 flex justify-center">
                                    {/* LINE */}
